...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Bloom Routine is a cozy daily planner app and daily routine app that turns tasks and habits into a calm, animated spring garden." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Daily Planner App & Daily Routine App — Bloom Routine" },
      { property: "og:description", content: "A cozy daily planner and daily routine app that grows a peaceful garden as you finish your day." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Daily Planner App & Daily Routine App — Bloom Routine" },
      { name: "twitter:description", content: "A cozy daily planner and daily routine app that grows a peaceful garden as you finish your day." },
